function Yn_v = Measured_data_processing_v_ref (time,N, Numb_obs_file)
...
try  
    ...
    Yn_v{g,1} = rot90(U_i); % Time serie itself
    ...
    elseif length(Yn_v{g,2}) == N
        ...
        if length(Yn_v{g,5}) ~= N
            ...
            if m < 0 || m == 0
                ...
                add_end = linspace(1+Yn_v{g,5}(end), N - 1, m);
